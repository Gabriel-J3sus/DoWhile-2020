    ...
    <View style={styles.container}>
      <View style={styles.comparisonContainer}>
        ...
        <View style={styles.businessAnalyticsContainer}>
          ...
          >
            <CustomBarChart chartData={yourBusinessData} chartDimensions={yourBusinessDimensions} />
          </View>
        </View>
        <View style={styles.businessAnalyticsContainer}>
          <View style={styles.businessAnalyticsData}>
          ...
          <View style={styles.businessAnalyticsChart} onLayout={({ 
              nativeEvent: { 
                layout: { width, height }
              }
          ...
          >
            <CustomBarChart chartData={yourCompetitorData} chartDimensions={yourCompetitorDimensions} />
          </View>
        </View>
        <TouchableOpacity
